...
// Auto-generated
@WebServlet("/api/update_cap_friendly_player")
final public class UpdateCapFriendlyPlayer extends AuthenticatedServlet { 

    private static final Logger LOGGER = Logger.getLogger(UpdateCapFriendlyPlayer.class.getName());
    ...
    protected Map<String, Object> doGetBody(
        ...
        try (final Connection conn = getNoAutoCommitConnection()) {
            final ExecutionResult<CapFriendlyPlayer> er = CapFriendlyPlayerDL.update(conn
