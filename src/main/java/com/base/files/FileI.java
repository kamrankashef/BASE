package com.base.files;

import com.base.files.common.DBUtil;
import com.base.files.org.test.EmptyTest;
import static com.base.util.StreamUtil.getProjectFile;
import java.io.File;
...
final public class FileI {
    ...
    private static final String LOCAL_COMMON_PATH = "com/base/files/common/";
